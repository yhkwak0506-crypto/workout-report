...
# 💡 V14.0 패치: 불필요한 import ai_service를 완전히 제거하여 에러 차단
...
def main():
    st.set_page_config(page_title="S-Tier Performance Vault", page_icon="⚽", layout="wide")
    init_session_state()
    ...
    if bootcamp_mode:
        ...
        st.title("⚽ S-Tier 프로 복귀 데이터 볼트 v14.0")
